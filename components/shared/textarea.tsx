  ...
  return (
    <div className="w-full relative">
      <textarea
        ...
        placeholder=""
        className={`peer w-full p-4 pt-6 resize-none h-[150px] outline-none bg-white font-light
      ...
      <label
        ...
        top-5 origin-[0] left-4 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0
